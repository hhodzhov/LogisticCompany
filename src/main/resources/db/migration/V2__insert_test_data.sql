...
INSERT INTO "nbu-project".api_user (id, "name", "password", username)
VALUES (1, 'Ivan Ivanov', '$2a$10$31sCb28VeTaqu/odel2txusm.p1vEzZmiv09Wwrka6DJnbLjn9ehG', 'vankata1'),
       (2, 'Petar Petrov', '$2a$10$q4Pm38HMIG7YRs5Lcj4hy.d2VPyjR10iJfMj9wQj.6TwgV8ZtY/Iu', 'pesho1'),
       (3, 'Alexander Stoyanov', '$2a$10$qpCpuHMihOpd6VMk4rgnXeYfvReRmqrnn0B0AaOckUPscTu45VknC', 'sashenkata1'),
       (4, 'Petar Tudzharov', '$2a$10$oVhjsGlf9W0ZIWdtl28wI.FFxOhQLhaXw1BJ1.9B7nH4wc2n57w6q', 'djaro1'),
       (5, 'Vladimir Popov', '$2a$10$J8Hg8/.MBkH.bS6UpKthq.kOddpipVV47SumwFBYYqpIXDcPjzziu', 'popov1'),
       (6, 'Martin Hristov', '$2a$10$cc1IDkpUEnT39n6o5goIDOw0saBJXKAEHMSscxQcJ0mR7TMgk99aG', 'hristov1'),
       (7, 'Ivaylo Zahariev', '$2a$10$mv2Md3tL1pBl6UimCjC1M.nJVNAuHETU88dKNnAJdmH0hHJoY5lI6', 'ivak1'),
       (8, 'Vladimir Chervenski', '$2a$10$JS3T20hlshjckCFcwIW7SOQIIUW5/VLLI0TCiCi246YhZp0U0CFnS', 'vlado1');
